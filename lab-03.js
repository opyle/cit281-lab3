//  Part 11: Import reverseString() and concatenateString()
...
//  Part 2: Create make and model variables using object destructuring
...
//  Part 6: Study the following code that will list all 
...
//  Part 7: Display all array values using for..of syntax
// Comment out the original for loop code using single line comments
for(let prime of primes){
    console.log(prime)
}

//  Part 12: Import and use reverseString() and concatenateString() in
